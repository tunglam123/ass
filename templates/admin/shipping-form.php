    ...
    <table cellspacing="1" class="mainTable" id="shipping">
      ...
      <tbody>
        ...
        <tr class="l1">
          ...
          <td>
            <input type="text" name="fPrice" value="<?php if( isset( $aData['fPrice'] ) ) echo $aData['fPrice']; ?>" class="inputr" size="10" alt="float" tabindex="2" /> <?php echo $config['currency_symbol']; ?>
          </td>
        </tr>
        <!-- price end -->
        <tr class="l0">
