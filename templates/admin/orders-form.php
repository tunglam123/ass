...
if( isset( $aData ) && is_array( $aData ) ){
  ...
  <form action="?p=<?php echo $p; ?>&amp;iOrder=<?php echo $aData['iOrder']; ?>" method="post" id="mainForm" onsubmit="return checkForm( this );">
    <fieldset id="type2">
      ...
      <table cellspacing="1" class="mainTable" id="order">
        ...
        <tbody>
          ...
          <tr class="l0">
            <th>
              <?php echo $lang['First_and_last_name']; ?>
            </th>
            <td>
              <input type="text" name="sFirstName" value="<?php echo $aData['sFirstName']; ?>" size="24" maxlength="30" class="input" alt="simple" accesskey="1" tabindex="2" />
              <input type="text" name="sLastName" value="<?php echo $aData['sLastName']; ?>" size="24" maxlength="40" class="input" alt="simple" tabindex="2" />
            </td>
                  ...
                  <table class="tab" id="tabProductsPayment">
                    ...
                    <tbody>
                      ...
                      <tr id="addProductForm" style="display:none;">
                        ...
                        <tr>
                        <td class="id"><input type="text" name="iShipping" value="<?php if( isset( $aData['iShipping'] ) ) echo $aData['iShipping']; ?>" size="2" class="input" alt="int;0;;;if" /></td>
                        ...
                        <td class="price" colspan="4"><input type="text" name="fShippingPrice" value="<?php if( isset( $aData['fShippingPrice'] ) ) echo $aData['fShippingPrice']; ?>" class="inputr" size="7" maxlength="15" alt="float;;if" /><span class="info""> - <?php echo $lang['Shipping']; ?></span></td>
                      </tr>
                      <tr>
          ...
          <tr class="l0">
            ...
            <td>
              <input type="text" name="sStreet" value="<?php echo $aData['sStreet']; ?>" size="50" maxlength="40" class="input" alt="simple" tabindex="4" />
            </td>
          </tr>
          <!-- street end -->
          <!-- zip_code start -->
          <tr class="l1">
            ...
            <td>
              <input type="text" name="sZipCode" value="<?php echo $aData['sZipCode']; ?>" size="50" maxlength="20" class="input" alt="simple" tabindex="5" />
            </td>
          </tr>
          <!-- zip_code end -->
          <!-- city start -->
          <tr class="l0">
            ...
            <td>
              <input type="text" name="sCity" value="<?php echo $aData['sCity']; ?>" size="50" maxlength="40" class="input" alt="simple" tabindex="6" />
            </td>
          </tr>
          <!-- city end -->
          <!-- telephone start -->
          <tr class="l1">
            ...
            <td>
              <input type="text" name="sPhone" value="<?php if( isset( $aData['sPhone'] ) ) echo $aData['sPhone']; ?>" size="50" maxlength="40" class="input" alt="simple" tabindex="7" />
            </td>
          </tr>
          <!-- telephone end -->
          <!-- email start -->
          <tr class="l0">
            ...
            <td>
              <input type="text" name="sEmail" value="<?php echo $aData['sEmail']; ?>" size="50" maxlength="40" class="input" alt="email" tabindex="8" />
            </td>
          </tr>
          <!-- email end -->
          <!-- date start -->
