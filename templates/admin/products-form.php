...
<form action="?p=<?php echo $p; ?>&amp;iProduct=<?php if( isset( $aData['iProduct'] ) )echo $aData['iProduct']; ?>" name="form" enctype="multipart/form-data" method="post" id="mainForm" onsubmit="return checkForm( this );">
  <fieldset id="type1">
    ...
    <table cellspacing="0" class="mainTable" id="product">
      ...
      <tbody><!-- name start -->
                ...
                <table class="tab" id="tabOptions">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <span id="pageParentCtn"><select name="aPages[]" size="15" multiple="multiple" title="simple" id="oPageParent" tabindex="5" onclick="cloneClick( this, 'pageParent2' )"><?php echo $oPage->throwProductsPagesSelectAdmin( isset( $aData['aCategories'] ) ? $aData['aCategories'] : null ); ?></select></span>
        ...
        <tr class="l1">
          <td>
            <input type="text" name="sName" value="<?php if( isset( $aData['sName'] ) ) echo $aData['sName']; ?>" class="input" style="width:100%;" alt="simple" accesskey="1" tabindex="1" />
          </td>
        </tr>
        <!-- name end -->
        <!-- price start -->
